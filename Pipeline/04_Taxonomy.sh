...
${diamond} blastp -q ${GeneCatalog}/01_before_cdhit/total.protein.faa.90 -d ${Database}/uniprot/uniprot_trembl.dmnd -t tmp -p 8 -e 1e-5 -k 50 --id 30 --sensitive -o ${Taxonomy}/total.protein.faa.90.diamond2uniprot_trembl    
